package com.kwaishop.digital.access.demo.domain.order.request;
 ...
 */
@Data
public class OrderListDomainRequest {
    /**
    ...
    public OrderCursorListProxyReq toProxyReq() {
        OrderCursorListProxyReq proxyReq = new OrderCursorListProxyReq();
